...
.cidg-website-banner { grid-template-columns:60px max-content; column-gap:12px; align-items:center; }
.cidg-header-emblem { grid-column:1; grid-row:1 / 3; display:block; width:60px; height:60px; justify-self:center; transform:translateY(3px); object-fit:contain; mix-blend-mode:screen; mask-image:none; }
...
@media(max-width:600px) {
 ...
 .cidg-header-emblem { width:36px; height:36px; transform:translateY(2px); }
