...
.cidg-header-emblem { grid-column:1; grid-row:1 / 3; display:block; width:56px; height:56px; object-fit:contain; mix-blend-mode:screen; mask-image:radial-gradient(ellipse at center,#000 54%,transparent 73%); }
...
@media(max-width:600px) {
 ...
 .cidg-header-emblem { width:36px; height:36px; }
